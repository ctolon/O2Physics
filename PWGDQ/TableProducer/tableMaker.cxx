...
struct TableMaker {
  ...
  Configurable<std::string> fConfigAddEventHistogram{"cfgAddEventHistogram", "triggerall,cent", "Comma separated list of histograms"};
  Configurable<std::string> fConfigAddTrackHistogram{"cfgAddTrackHistogram", "dca,its,tpcpid,tofpid", "Comma separated list of histograms"};
