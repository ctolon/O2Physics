...
struct TableMakerMC {
  ...
  Configurable<std::string> fConfigAddEventHistogram{"cfgAddEventHistogram", "triggerall,cent,mc", "Comma separated list of histograms"};
  Configurable<std::string> fConfigAddTrackHistogram{"cfgAddTrackHistogram", "dca,its,tpcpid,tofpid,mc", "Comma separated list of histograms"};
  Configurable<std::string> fConfigAddMuonHistogram{"cfgAddMuonHistogram", "muon,mc", "Comma separated list of histograms"};
  Configurable<std::string> fConfigAddMCTruthHistogram{"cfgAddMCTruthHistogram", "mctruth", "Comma separated list of histograms"};
